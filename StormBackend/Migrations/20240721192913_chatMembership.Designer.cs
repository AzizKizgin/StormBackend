...
namespace StormBackend.Migrations
{
    ...
    [Migration("20240721192913_chatMembership")]
    partial class chatMembership
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("StormBackend.Models.ChatMembership", b =>
                {
                    b.HasOne("StormBackend.Models.Chat", "Chat")
                        .WithOne("ChatMember1")
                        .HasForeignKey("StormBackend.Models.ChatMembership", "ChatId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StormBackend.Models.Chat", null)
                        .WithOne("ChatMember2")
                        .HasForeignKey("StormBackend.Models.ChatMembership", "Id")
